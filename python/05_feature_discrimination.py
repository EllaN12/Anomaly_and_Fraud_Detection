"""
LEARNING LAB 17 (Python port) -- 05 FEATURE DISCRIMINATION
============================================================
...
def _find_csv(name: str = "creditcard.csv") -> Path:
    for candidate in [
        ...
        PROJECT.parent / "lab_17_anomaly_detection_h2o" / "data" / name,
    ]:
        if candidate.exists():
            return candidate
    raise FileNotFoundError(f"{name} not found relative to {PROJECT}")
